...
Version: 1.0.0
Author: Compound Interest Calculator / www.calculator.io
...
function display_calcio_ci_compound_interest_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_compound_interest_calculator', 'display_calcio_ci_compound_interest_calculator' );